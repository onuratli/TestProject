...
class GiftViewController: UIViewController {
    ...
    var iconArray: [UIImage] = [UIImage(named: "ipad")!, UIImage(named: "macbook")!,UIImage(named: "iphone")!,UIImage(named: "suzuki")!,UIImage(named: "indigo")!,UIImage(named: "sandero")!]
    
    var titleArray:[String] = ["IPAD" , "MACBOOK", "IPHONE" , " Suzuki motorsiklet" , "Tata Indıgo" , "Dacia Sandero"]
    ...
    var contentArray:[String] = ["Gold Kart'a geçen müşterilerimize hediyemiz Ipad" , "Platinium Kart'a geçen müşterilerimize hediyemiz Macbook Air" , "Business Kart'a geçen müşterilerimize hediyemiz  Iphone" , "450.000 puana Suzuki marka motorsiklet" , "650.000 Puana Tata Indıgo marka otomobil" , "950.000 Puana Dacia Sandero marka SUV"]
    ...
    override func viewDidLoad() {
        ...
        tblView.frame = CGRect(x: 0, y: -90, width: self.view.frame.width, height: self.view.frame.height+40)
